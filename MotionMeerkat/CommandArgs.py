...
def CommandArgs():
    ...
    parser.add_argument("--todraw", help="Draw boxes to highlight motion'?",action="store_false")
    parser.add_argument("--show", help="Show frames as you process",default='frames',action='store_false')
