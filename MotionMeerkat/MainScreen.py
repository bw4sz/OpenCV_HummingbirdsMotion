...
class MainScreen(Screen):
    ...
    Screen.mode='auto'
    Screen.set_ROI=False
    Screen.mogl=3
    Screen.mogv=3
    Screen.drawSmall='enter'
    ...
    Screen.fc=TextInput(text="Input File or Folder",font_size=20,size_hint=(1,.5))
    Screen.outd=TextInput(text="Output Location (C:/MotionMeerktat)",font_size=20,size_hint=(.645,.5),pos_hint={'center_x':0.485})
    ...
    banner.add_widget(Screen.fc)
    banner.add_widget(mm)
    
    #add banner to overall 
    b.add_widget(banner)
    b.add_widget(Screen.outd)
    ...
    Screen.mstext=TextInput(text="0.03",size_hint=(.3,1),pos_hint={'center_x':0.5})
    
    ms_layout.add_widget(drawl)
    ms_layout.add_widget(Screen.mstext)
    ...
    def run_press(instance):
        ...
        #File
        motionVid.inDEST=Screen.fc.text
    
        #destination
        motionVid.fileD=Screen.outd.text                
        
        #mode
        motionVid.mode=Screen.mode
        
        #region of interest
        motionVid.set_ROI=Screen.set_ROI
        
        #Mog params
        motionVid.q1=Screen.mogl
        motionVid.q2=Screen.mogv
        
        #size params
        motionVid.drawSmall=Screen.drawSmall
        motionVid.minSIZE=float(Screen.mstext.text)
